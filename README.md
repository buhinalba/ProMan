...
- <i class="far fa-exclamation"></i> [Callbacks](https://learn.code.cool/full-stack/#/../pages/javascript/javascript-callbacks)
- <i class="far fa-exclamation"></i> [API, AJAX](https://learn.code.cool/full-stack/#/../pages/web/the-last-missing-piece-api)
- <i class="far fa-exclamation"></i> [RESTful](https://learn.code.cool/full-stack/#/../pages/web/restful)
